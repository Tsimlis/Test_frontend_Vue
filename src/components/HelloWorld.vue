    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="row p-3">
          ...
          <h6 class="text">Komgrip Technology</h6>
        </div>
      ...
      <div class="col-lg-9">
        ...
        <div class="row mb-5">
          ...
          <div class="col">
            <i class="fa fa-user" aria-hidden="true"></i><h6>Jaroon Ritdechwong</h6>
          </div>
              ...
              <div class="table-responsive">
                <div class="row p-3">
                  ...
                  <div class="col-lg-9 col-5 my-auto text-end">
                    <button class="btn btn-info m-3" @click="prevBtn()" disabled> prev </button>
